  ...
  <div className="row">
    ...
    <div className="col-lg-4 col-xs-12 location">
     ...
     <div className="limage">
              <Link href="https://web.facebook.com/6Pssoundfulsystem/"><a><img src="/images/Facebook.png" alt="Facebook"  /> </a></Link>
              <Link href="https://www.instagram.com/6pssoundful/"><a><img src="/images/Instagram Circle.png" alt="Instagram" /></a></Link>
              <Link href="/"><a><img src="/images/Twitter Circled.png" alt="Twitter" /></a></Link>
              <Link href="/"><a><img src="/images/WhatsApp.png" alt="Whatsapp" /></a></Link>
      </div>
              
      <Link href="/market"><a className="text-white-50">Recent Events &gt;&gt;&gt;</a></Link>
