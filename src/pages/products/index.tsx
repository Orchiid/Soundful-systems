        ...
        <Wrapper className="productmain">
          <section className="productsection">
            <div className="product-head sound container-fluid">
              ...
              <p className=" fw-200 ">
                We have in our fleet only the best high – end equipment from the
                biggest brand on the professional market and our great in-house
                capability enable us to deliver our products for everything from
                stadium to the very intimate concert or conference.
              </p>
            </div>
          </section>
